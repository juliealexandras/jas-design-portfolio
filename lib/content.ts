...
export const projects: Project[] = [
  ...
  },
  {
    ...
    overview: [
      "The Alexa+ Store reimagined Alexa Skills as a marketplace for AI-powered experiences, integrations, and add-ons. I helped turn a fragmented ecosystem into something customers could browse, understand, and utilize with confidence across mobile, web, and multimodal surfaces.",
    ],
    overviewLinks: [
  ...
  },
  {
    ...
    deck: [
      ...
      {
        src: "/work/library-subs-ux-deck/3.png",
  ...
  },
  {
    ...
    overview: [
      "Alexa Emergency Assist combined the foundations of Alexa Guard and Alexa Together into a single safety-focused service for elders and their caregivers. I helped simplify the journey from purchase to setup, balancing gifting, promotions, emergency requirements, and onboarding flows while the product and brand continued to evolve.",
    ],
    overviewLinks: [
